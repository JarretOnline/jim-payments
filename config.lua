...
Config = {
	...
	Jobs = {
		['burgershot'] = { MinAmountforTicket = 10, PayPerTicket = 10 , Commission = 0.20, },
		['casino'] = { MinAmountforTicket = 10, PayPerTicket = 10 , Commission = 0.20, },
		['whitewidow'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.20, },
		['bestbuds'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.20, },
		['mechanic'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.20, },
		['taxi'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.20, },
		--['pesos'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0.10, gang = true, }, -- Example of a gang being supported
	},
	...
	CustomCashRegisters = { -- Located in the config.lua
		["police"] = { -- Player job role restriction
	 	 { coords = vector4(473.51, -1006.44, 26.10, 2.06), prop = true, }, -- vector4 to place the till and the way it faces
		},
		["ambulance"] = { -- Player job role restriction
		{ coords = vector4(309.79, -596.0, 43.28, 161.0), prop = true, }, -- vector4 to place the till and the way it faces
	  },
  	},
	...
	FineJobs = {
		['police'] = { Commission = 0.20, },
		['ambulance'] = { Commission = 0.20, },
	},
